...
class DiseasePrediction:
    ...
    def __init__(self, model_name=None):
        ...
        self._feature_correlation(data_frame=self.test_features, show_fig=False)
        # Model Definition
    ...
    def _load_train_dataset(self):
        ...
        train_labels = df_train['disease']
        # print(train_features)

        # Check for data sanity
        # print(len(train_features.iloc[0]))
        assert (len(train_features.iloc[0]) == 489)
    ...
    def _load_test_dataset(self):
        ...
        test_labels = df_test['disease']

        # Check for data sanity
        assert (len(test_features.iloc[0]) == 489)
